 ...
 * @version $Id: SolrIndexer.java 1534 2011-10-05 20:59:11Z rh9ec@virginia.edu $
 * 
 */
/**
 * @author rh9ec
...
//                      logger.error("Record " + (recCntlNum != null ? recCntlNum : "") + " not indexed because " + key + " field is empty -- " + e.getMessage(), e);
     ...
     * @param record - the marc record object
     * @return 260c or 008[7-10] or 008[11-14], "cleaned" per org.solrmarc.tools.DateUtils.cleanDate()
     */
