...
{<img src="https://secure.travis-ci.org/solrmarc/stanford-solr-marc.png?branch=master" alt="Build Status" />}[http://travis-ci.org/solrmarc/stanford-solr-marc]
...
* clone the project
 ...
 git clone git://github.com/solrmarc/stanford-solr-marc.git
