...
@Test
	public void testLCLopping() {
		...
		assertEquals(callnum, ItemUtils.getLoppedCallnum(callnum, CallNumberType.LC, isSerial));
		assertEquals(callnum, ItemUtils.getLoppedCallnum(callnum, CallNumberType.LC, !isSerial));

		// Vol piece only
		callnum = "HE 2708.I854 V.666";
		assertEquals("HE 2708.I854", ItemUtils.getLoppedCallnum(callnum, CallNumberType.LC, isSerial));
		assertEquals("HE 2708.I854", ItemUtils.getLoppedCallnum(callnum, CallNumberType.LC, !isSerial));
		callnum = "BM198.2 .H85 OCT 2006";
		assertEquals("BM198.2 .H85", ItemUtils.getLoppedCallnum(callnum, CallNumberType.LC, isSerial));
		assertEquals("BM198.2 .H85", ItemUtils.getLoppedCallnum(callnum, CallNumberType.LC, !isSerial));
		
		// year suffix - should be lopped for serial only
		callnum = "M270 .I854 1999";
		assertEquals("M270 .I854", ItemUtils.getLoppedCallnum(callnum, CallNumberType.LC, isSerial));
		assertEquals(callnum, ItemUtils.getLoppedCallnum(callnum, CallNumberType.LC, !isSerial));

		// vol then year
		callnum = "TX519 .D26 V.2 1966";  
		assertEquals("TX519 .D26", ItemUtils.getLoppedCallnum(callnum, CallNumberType.LC, isSerial));
		assertEquals("TX519 .D26", ItemUtils.getLoppedCallnum(callnum, CallNumberType.LC, !isSerial));
		
		// year then vol - year suffix should be lopped for serial only
		callnum = "TX519 .D26 1954 V.2";  
		assertEquals("TX519 .D26", ItemUtils.getLoppedCallnum(callnum, CallNumberType.LC, isSerial));
		assertEquals("TX519 .D26 1954", ItemUtils.getLoppedCallnum(callnum, CallNumberType.LC, !isSerial));		
	}
...
@Test
	public void testDeweyLopping() {	
		...
		assertEquals(callnum, ItemUtils.getLoppedCallnum(callnum, CallNumberType.DEWEY, isSerial));
		assertEquals(callnum, ItemUtils.getLoppedCallnum(callnum, CallNumberType.DEWEY, !isSerial));

		// Vol piece only
		callnum = "553.2805 .P117 NOV/DEC 2009";  // 7888686
		assertEquals("553.2805 .P117", ItemUtils.getLoppedCallnum(callnum, CallNumberType.DEWEY, isSerial));
		assertEquals("553.2805 .P117", ItemUtils.getLoppedCallnum(callnum, CallNumberType.DEWEY, !isSerial));
		callnum = "621.38406 .B865 F V.5:NO.3-6 2007/2008";  // 6913279
		assertEquals("621.38406 .B865 F", ItemUtils.getLoppedCallnum(callnum, CallNumberType.DEWEY, isSerial));
		assertEquals("621.38406 .B865 F", ItemUtils.getLoppedCallnum(callnum, CallNumberType.DEWEY, !isSerial));
				
		// year only
		callnum = "331.06931 .N566 2007";  // 7752489
		assertEquals("331.06931 .N566", ItemUtils.getLoppedCallnum(callnum, CallNumberType.DEWEY, isSerial));
		assertEquals(callnum, ItemUtils.getLoppedCallnum(callnum, CallNumberType.DEWEY, !isSerial));
		
		// vol then year
		callnum = "505 .N285B V.241-245 1973";
		assertEquals("505 .N285B", ItemUtils.getLoppedCallnum(callnum, CallNumberType.DEWEY, isSerial));
		assertEquals("505 .N285B", ItemUtils.getLoppedCallnum(callnum, CallNumberType.DEWEY, !isSerial));
		callnum = "505 .N285 V.458:543--1212 2009";
		assertEquals("505 .N285", ItemUtils.getLoppedCallnum(callnum, CallNumberType.DEWEY, isSerial));
		assertEquals("505 .N285", ItemUtils.getLoppedCallnum(callnum, CallNumberType.DEWEY, !isSerial));

		// year then vol
		callnum = "553.2805 .P117 2009 SEP";  // 7888686
		assertEquals("553.2805 .P117", ItemUtils.getLoppedCallnum(callnum, CallNumberType.DEWEY, isSerial));
		assertEquals("553.2805 .P117 2009", ItemUtils.getLoppedCallnum(callnum, CallNumberType.DEWEY, !isSerial));
	}
...
@Test
	public void testOtherLopping() {
		...
		assertEquals(callnum, ItemUtils.getLoppedCallnum(callnum, CallNumberType.SUDOC, isSerial));
		assertEquals(callnum, ItemUtils.getLoppedCallnum(callnum, CallNumberType.SUDOC, !isSerial));
		...
		assertEquals(callnum, ItemUtils.getLoppedCallnum(callnum, CallNumberType.OTHER, isSerial));
		assertEquals(callnum, ItemUtils.getLoppedCallnum(callnum, CallNumberType.OTHER, !isSerial));
		callnum = "SUSEL-69048";
		assertEquals(callnum, ItemUtils.getLoppedCallnum(callnum, CallNumberType.OTHER, isSerial));
		assertEquals(callnum, ItemUtils.getLoppedCallnum(callnum, CallNumberType.OTHER, !isSerial));
		...
		assertEquals("DPI/SER.Z/3", ItemUtils.getLoppedCallnum(callnum, CallNumberType.SUDOC, isSerial));
		assertEquals(callnum, ItemUtils.getLoppedCallnum(callnum, CallNumberType.SUDOC, !isSerial));
		callnum = "ST/GENEVA/LIB/SER.B/REF.";
		assertEquals("ST/GENEVA/LIB", ItemUtils.getLoppedCallnum(callnum, CallNumberType.OTHER, isSerial));
		assertEquals("ST/GENEVA/LIB", ItemUtils.getLoppedCallnum(callnum, CallNumberType.OTHER, !isSerial));
		callnum = "TD 5.9:V.6/986";
		assertEquals("TD 5.9", ItemUtils.getLoppedCallnum(callnum, CallNumberType.SUDOC, isSerial));
		assertEquals("TD 5.9", ItemUtils.getLoppedCallnum(callnum, CallNumberType.SUDOC, !isSerial));
		callnum = "M1522 BOX 1";
		assertEquals("M1522", ItemUtils.getLoppedCallnum(callnum, CallNumberType.OTHER, isSerial));
		assertEquals("M1522", ItemUtils.getLoppedCallnum(callnum, CallNumberType.OTHER, !isSerial));
		callnum = "MFILM N.S. 1350 REEL 230 NO. 3741";
// NOTE:  actually lopped by longest common prefix, so ok.
//		assertEquals("MFILM N.S. 1350 REEL 230", ItemUtils.getLoppedCallnum(callnum, CallNumberType.OTHER, isSerial));
//		assertEquals("MFILM N.S. 1350 REEL 230", ItemUtils.getLoppedCallnum(callnum, CallNumberType.OTHER, !isSerial));						
		callnum = "CALIF L1080 .J67 V.1-12:NO.1";
		assertEquals("CALIF L1080 .J67", ItemUtils.getLoppedCallnum(callnum, CallNumberType.OTHER, isSerial));		
		assertEquals("CALIF L1080 .J67", ItemUtils.getLoppedCallnum(callnum, CallNumberType.OTHER, !isSerial));
		// dewey cutter invalid: starts 2 letters - treated as non-dewey		
		callnum = "888.4 .JF78A V.5";
		assertEquals("888.4 .JF78A", ItemUtils.getLoppedCallnum(callnum, CallNumberType.OTHER, isSerial));
		assertEquals("888.4 .JF78A", ItemUtils.getLoppedCallnum(callnum, CallNumberType.OTHER, !isSerial));
		
		// year only
		callnum = "CALIF D210 .B34GE 2008";
		assertEquals("CALIF D210 .B34GE", ItemUtils.getLoppedCallnum(callnum, CallNumberType.OTHER, isSerial));
		assertEquals(callnum, ItemUtils.getLoppedCallnum(callnum, CallNumberType.LC, !isSerial));
		callnum = "CALIF S405 .R4 2000";
		assertEquals("CALIF S405 .R4", ItemUtils.getLoppedCallnum(callnum, CallNumberType.OTHER, isSerial));
		assertEquals(callnum, ItemUtils.getLoppedCallnum(callnum, CallNumberType.LC, !isSerial));
		callnum = "E 8.1: 2006";
		assertEquals("E 8.1", ItemUtils.getLoppedCallnum(callnum, CallNumberType.OTHER, isSerial));
		assertEquals(callnum, ItemUtils.getLoppedCallnum(callnum, CallNumberType.OTHER, !isSerial));
		
		// vol then year
		callnum = "CALIF G255 .R4 NO.I-1B 1978"; // 425082
		assertEquals("CALIF G255 .R4", ItemUtils.getLoppedCallnum(callnum, CallNumberType.OTHER, isSerial));
		assertEquals("CALIF G255 .R4", ItemUtils.getLoppedCallnum(callnum, CallNumberType.OTHER, !isSerial));
		
		// year then vol
		callnum = "CALIF G255 .R4 1978 OCT.23";
		assertEquals("CALIF G255 .R4", ItemUtils.getLoppedCallnum(callnum, CallNumberType.OTHER, isSerial));
		assertEquals("CALIF G255 .R4 1978", ItemUtils.getLoppedCallnum(callnum, CallNumberType.OTHER, !isSerial));
		callnum = "CALIF G255 .R4 NO.I-1B 1978 OCT.23";
		assertEquals("CALIF G255 .R4 NO.I-1B", ItemUtils.getLoppedCallnum(callnum, CallNumberType.OTHER, isSerial));
		assertEquals("CALIF G255 .R4 NO.I-1B 1978", ItemUtils.getLoppedCallnum(callnum, CallNumberType.OTHER, !isSerial));
	}
...
@Test
	public void testLoppingShelbyTitleCallnum()
	{
		...
		assertEquals("V.35-37", ItemUtils.getLoppedCallnum(callnum, CallNumberType.LC, isSerial));
		
		// LC
		callnum = "QA276 .J86 V.27 NOS.4-6 2006";  // 491239  LCPER
		assertEquals("QA276 .J86", ItemUtils.getLoppedCallnum(callnum, CallNumberType.LC, isSerial));
