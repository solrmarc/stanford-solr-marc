...
nohup java -Xmx16g -Xms16g -Dsolr.data.dir=$SOLR_DATA_DIR -jar $SOLRMARC_JAR $RAW_DATA_DIR/uni_00500000_00999999.marc &>$LOG_DIR/log050-099.txt
nohup java -Xmx16g -Xms16g -Dsolr.data.dir=$SOLR_DATA_DIR -jar $SOLRMARC_JAR $RAW_DATA_DIR/uni_01000000_01499999.marc &>$LOG_DIR/log100-149.txt
nohup java -Xmx16g -Xms16g -Dsolr.data.dir=$SOLR_DATA_DIR -jar $SOLRMARC_JAR $RAW_DATA_DIR/uni_01500000_01999999.marc &>$LOG_DIR/log150-199.txt
nohup java -Xmx16g -Xms16g -Dsolr.data.dir=$SOLR_DATA_DIR -jar $SOLRMARC_JAR $RAW_DATA_DIR/uni_02000000_02499999.marc &>$LOG_DIR/log200-249.txt
nohup java -Xmx16g -Xms16g -Dsolr.data.dir=$SOLR_DATA_DIR -jar $SOLRMARC_JAR $RAW_DATA_DIR/uni_02500000_02999999.marc &>$LOG_DIR/log250-299.txt
nohup java -Xmx16g -Xms16g -Dsolr.data.dir=$SOLR_DATA_DIR -jar $SOLRMARC_JAR $RAW_DATA_DIR/uni_03000000_03499999.marc &>$LOG_DIR/log300-349.txt
nohup java -Xmx16g -Xms16g -Dsolr.data.dir=$SOLR_DATA_DIR -jar $SOLRMARC_JAR $RAW_DATA_DIR/uni_03500000_03999999.marc &>$LOG_DIR/log350-399.txt
nohup java -Xmx16g -Xms16g -Dsolr.data.dir=$SOLR_DATA_DIR -jar $SOLRMARC_JAR $RAW_DATA_DIR/uni_04000000_04499999.marc &>$LOG_DIR/log400-449.txt
nohup java -Xmx16g -Xms16g -Dsolr.data.dir=$SOLR_DATA_DIR -jar $SOLRMARC_JAR $RAW_DATA_DIR/uni_04500000_04999999.marc &>$LOG_DIR/log450-499.txt
nohup java -Xmx16g -Xms16g -Dsolr.data.dir=$SOLR_DATA_DIR -jar $SOLRMARC_JAR $RAW_DATA_DIR/uni_05000000_05499999.marc &>$LOG_DIR/log500-549.txt
nohup java -Xmx16g -Xms16g -Dsolr.data.dir=$SOLR_DATA_DIR -jar $SOLRMARC_JAR $RAW_DATA_DIR/uni_05500000_05999999.marc &>$LOG_DIR/log550-599.txt
